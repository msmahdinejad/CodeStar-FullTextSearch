...
public class SearchInitializerTests
{
    ...
    public void Build_ShouldCallCorrectMethods_Whenever()
    {
        ...
        var sut = new SearchInitializer(inputDataFolderReaderFactoryMock.Object, invertedIndexMock.Object, inputSearchStrategyFactoryMock.Object, textEditorMock.Object);
        ...
        invertedIndexMock.Verify(x => x.AddDataListToMap(It.IsAny<IEnumerable<ISearchable>>()), Times.Once);
